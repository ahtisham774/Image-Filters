  ...
  return (
    ...
    <div className='preview_div'>
        ...
        <div className='preview'>
            ...
            <>
            <div className='rgb'>
                <Range name='radius' value={radius} min={0} max={1000} css='filter wid' range={'rgb_width'} handleChange={setRadius} />
            ...
            <div className='range_filters'>
                <div className='range_preview'>
                     <Range css='filter width' range={'range_width'} name='radius' min={0} max={1000} value={radius} handleChange={setRadius} /> 
